...
import { Search, Download, RotateCcw, Loader2, TrendingUp, Zap, Globe, ShieldCheck, BarChart2 } from "lucide-react";
    ...
    <div style={{ minHeight: "100vh", background: "#0a0f1e", color: "#e2e8f0", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <header style={{ background: "linear-gradient(160deg, #0a0f1e 0%, #0f1f3d 50%, #0a0f1e 100%)", borderBottom: "1px solid rgba(99,179,237,0.1)", padding: "3.5rem 1rem 3rem" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 800, margin: "0 0 0.75rem", letterSpacing: "-0.03em", lineHeight: 1.15,
            background: "linear-gradient(135deg, #fff 0%, #63b3ed 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            Competitor Analyzer
          </h1>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              <button onClick={handleAnalyze}
                ...
                style={{ marginTop: "0.5rem", padding: "0.9rem", fontSize: "1rem", fontWeight: 700,
                  background: status === "loading" || !product.trim() || !category.trim()
                    ? "rgba(99,179,237,0.3)"
        ...
        {status === "done" && (
          <div>
            ...
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16,
              padding: "2rem", fontSize: "0.92rem", lineHeight: 1.75 }}>
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "1.5rem 1rem", textAlign: "center" }}>
        <p style={{ color: "#334155", fontSize: "0.78rem", margin: 0 }}>
          Powered by DeepSeek AI + Tavily Search · Built for cross-border sellers
        </p>
      </footer>
